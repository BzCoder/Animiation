 ...
 */
public class RedPointViewWithTextView extends FrameLayout {
    ...
    public RedPointViewWithTextView(Context context) {
        super(context);
        initView();
    }

    public RedPointViewWithTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public RedPointViewWithTextView(Context context, AttributeSet attrs, int defStyle) {
